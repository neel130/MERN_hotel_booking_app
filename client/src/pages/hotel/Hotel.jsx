...
const Hotel = () => {
  ...
  useEffect(()=>{
   const getHotel = async()=>{
    const res = await fetch(`/hotel/find/${params.id}`);
        ...
        <div className="hotelWrapper">
          ...
          <div className="hotelDetails">
            <div className="hotelDetailsTexts">
              <h1 className="hotelTitle">{hotel.city}</h1>
            ...
            <div className="hotelDetailsPrice">
              ...
              <h2>
                <b>${112*day}</b> ({day} nights)
              </h2>
              <button onClick={BookRooms} >Reserve or Book Now!</button>
            </div>
          </div>
        </div>
        <MailList />
